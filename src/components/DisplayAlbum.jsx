...
const DisplayAlbum = () => {
  ...
  if (!albumData) return <p className="text-white">Album not found</p>;

  return (
    <div className="w-full m-2 px-6 pt-4 rounded bg-[#121212] text-white overflow-auto lg:w-[75%] lg:ml-0">
      <Navbar />

      <div className="mt-10 px-6 flex gap-8 flex-col md:flex-row md:items-start">
        <img className="w-48 md:w-56 rounded"
          src={albumData.image}
          alt=""
